...
//iinner0 = ______________________; // smaller inner size through divide with rounding off
//in1 = _____________________________; // number of processes that must have "inner0+1" unknowns
  if (icoord < in1) {  // the first in1 processes will have "iinner0+1" unknowns
//  iinner = ___________;
//  is = __________________________________; // note that "is" reflects the position of the 
...
//kinner0 = ______________________; // smaller inner size through divide with rounding off
//kn1 = _____________________________; // number of processes that must have "knner0+1" unknowns
  if (kcoord < kn1) {  // the first kn1 processes will have "kinner0+1" unknowns
//  kinner = ___________;
//  ks = __________________________________; // note that "ks" reflects the position of the 
                                             // first halo or boundary element of the subdomain
  } else {             // and all other will have kinner0 unknowns
//  kinner = _______;
//  ks = __________________________________________________;
  }
//kouter = _____________;
//ke = _______________;
...
//    MPI_...
//    MPI_... please use nonblocking recv and nonblocking send
//    MPI_...
//    MPI_...
//    MPI_...
